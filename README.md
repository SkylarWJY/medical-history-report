...
### 家里有人生病，一箱看不懂的检查单 —— 一句话，变成一份家人都能看懂的健康报告。

*Drop in years of messy medical records → get ONE clear, mobile-friendly health report.*
...
```
①  把病历丢给 Claude              ②  说一句话                 ③  拿到报告
   （文件夹 / zip / 一堆扫描图）  →  "帮我整理成健康报告"  →   一份 HTML（可导长图/PDF）
```
